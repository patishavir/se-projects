...
public final class JdirParameters {
	private static String ChechedOutFilter = "";
	private static boolean clearCaseIntegrationEnabled = true;
	private static boolean clearCaseSupported = true;
	private static String enableCC = "no";
	private static String CompareUtilityPath = "C:\\Program Files\\Rational\\ClearCase\\bin\\cleardiffmrg.exe";
	private static String ViewPrivateFilter = "";
	//
	...
	static void processParameters(final String[] args) {
		...
		final String[][] parametersArray = { { "sourceDir", null }, { "destinationDir", null }, { "gui", "yes" },
				...
				{ "enableCC", "no" }, { "loggingLevel", "INFO" }, { "ConsoleHandler", "yes" }, { "FileHandler", "no" },
	...
	private static void processJdirDeployProperties() {
		...
		clearCaseSupported = jdirDeployProperties.getProperty("clearCasesupported").equalsIgnoreCase("yes");
		if (!clearCaseSupported) {
			clearCaseIntegrationEnabled = false;
		}
	...
	public static void disableClearCaseIntegration() {
		clearCaseIntegrationEnabled = false;
	}

	public static void enableClearCaseIntegration() {
		clearCaseIntegrationEnabled = true;
	}

	public static final String getChechedOutFilter() {
		return ChechedOutFilter;
	}
	...
	public static final String getViewPrivateFilter() {
		return ViewPrivateFilter;
	}

	public static final boolean isClearCaseIntegrationEnabled() {
		return clearCaseIntegrationEnabled;
	}

	public static final boolean isClearCaseSupported() {
		return clearCaseSupported;
	}

	static boolean isEnableCC() {
		return enableCC.equalsIgnoreCase("yes");
	}
	...
	public static void setChechedOutFilter(final String chechedOutFilter) {
		logger.finest(chechedOutFilter);
		ChechedOutFilter = chechedOutFilter;
		if (showOption != null) {
			DirMatchTable.getDirMatchTable().buidMatchTable(false);
		}
	}

	public static void setCompareUtilityPath(final String compareUtilityPath) {
		CompareUtilityPath = compareUtilityPath;
	}

	public static void setConsoleHandler(final String consoleHandlerP) {
	...
	public static void setDestinationDir(final String destinationDir) {
	...
	public static void setEnableCC(final String enableCC) {
		JdirParameters.enableCC = enableCC;
	}
	...
	public static void setFileHandler(final String fileHandlerP) {
	...
	public static void setFilePathExcludeFilter(final String filePathExcludeFilter) {
		FilePathExcludeFilter = filePathExcludeFilter;
	}

	public static void setFilePathIncludeFilter(final String filePathFilterP) {
	...
	public static void setFileType2Change(final String fileType2ChangeP) {
		JdirParameters.fileType2Change = fileType2ChangeP;
	}

	public static void setGui(final String gui) {
		JdirParameters.gui = gui;
	}

	public static void setLogFilePath(final String logFilePathP) {
		JdirParameters.logFilePath = logFilePathP;
	}

	public static void setLoggingLevel(final String loggingLevelP) {
	...
	public static void setNewFileType(final String newFileTypeP) {
	...
	public static void setOptionsGuiXmlFile(final String optionsGuiXmlFile) {
	...
	public static void setShow(final String show) {
	...
	public static void setSourceDir(final String sourceDir) {
	...
	public static void setViewPrivateFilter(final String viewPrivateFilesFilter) {
		ViewPrivateFilter = viewPrivateFilesFilter;
		if (showOption != null) {
			DirMatchTable.getDirMatchTable().buidMatchTable(false);
		}
	}
