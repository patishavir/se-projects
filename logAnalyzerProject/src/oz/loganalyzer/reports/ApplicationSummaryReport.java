...
public class ApplicationSummaryReport extends AbstractLogAnalyzerReport {
	...
	public final void specificReportLineProcessing(final LogRecord logRecord) {
		updateStatsMap(logRecord.getApplication(), logRecord);
	}

	protected final StringBuilder generateReport() {
		return generateSummaryReport("Application", fieldNames);
	}
}
