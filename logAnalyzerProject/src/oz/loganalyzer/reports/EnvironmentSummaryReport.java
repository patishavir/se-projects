...
public class EnvironmentSummaryReport extends AbstractLogAnalyzerReport {
	...
	public final void specificReportLineProcessing(final LogRecord logRecord) {
		updateStatsMap(logRecord.getEnvironment(), logRecord);
	}

	protected final StringBuilder generateReport() {
		return generateSummaryReport("Environment", fieldNames);
	}
}
