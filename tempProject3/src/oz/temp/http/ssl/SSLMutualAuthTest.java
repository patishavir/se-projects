...
public class SSLMutualAuthTest {
	...
	public static void main(String[] args) {
		...
		try {
			String CERT_ALIAS = "w284uea8.fibi.corp", CERT_PASSWORD = "kspass";
			...
			// Call a SSL-endpoint
			// callEndPoint(client, "https://secure.server.com/endpoint", new JSONObject().put("param1", "value1").put("param2", "value2"));
			callEndPoint(client, "https://s5381310.fibi.corp/oded.html", "GGGGGGGGGGGGGGGGGGGGGGGGGGGGGG");
		} catch (Exception ex) {
