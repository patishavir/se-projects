...
//			}
//		}
		String fullURL = "https://www.fibi-online.co.il/web/fibiwwwc";
		...
		if (!socksServer.equals("")) {
			...
			// Could check first to see if the user already specified it on the
			// invocation line
		...
		try {
			...
			URL page = new URL(fullURL); // Process the URL far enough to find
											// the right handler
			...
			System.out.println("Content-type = " + urlc.getContentType()); // See
																			// what's
																			// here
			System.out.println("Content-length = " + urlc.getContentLength()); // See
																				// how
																				// much
																				// of
																				// it
