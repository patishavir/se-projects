...
public class memberof {
	public static void main(String[] args) {
		...
		String adminName = "CN=צימרמן עודד,OU=3018666-טכנולוגיה וארכיטקטורה,OU=3018-תוכנת מערכות,OU=30-אגף טכנולוגיות מידע,OU=מתף,OU=FIBI,DC=fibi,DC=corp";
		String adminPassword = "ujik99";
		String ldapURL = "ldap://fibi.corp:389";
		...
		try {
			...
			String userSearchBase = "DC=fibi,DC=corp";
			...
			// Specify the Base for the search
			String groupsSearchBase = "DC=fibi,DC=corp";
			...
			// Search for objects using the filter
			String groutSearchFilterString = groupsSearchFilter.toString();
			NamingEnumeration groupsAnswer = ctx.search(groupsSearchBase, groutSearchFilterString, groupsSearchCtls);
