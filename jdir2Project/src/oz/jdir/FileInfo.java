...
public class FileInfo implements Comparable {
	...
	FileInfo(final File file, final String baseDirName) {
		...
		logger.finest("absolutepath: " + file.getAbsolutePath() + " baseDirName: " + baseDirName + " filePartialPath: "
				+ filePartialPath);
	}

	public FileInfo(final String filePartialPathP, final long fileLength, final long fileLastModifiedP,
			final boolean isFileP, final boolean isDirectoryP) {
