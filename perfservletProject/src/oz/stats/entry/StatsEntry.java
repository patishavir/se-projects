...
public class StatsEntry {
	...
	private long totalTime = OzConstants.LONG_0;
	...
	public StatsEntry(final String statLine) {
		String[] statsLineArray = statLine.trim().split(OzConstants.COMMA);
	...
	public String getAsString() {
		...
		for (StatsAttributesEnum statsAttributesEnumValue1 : statsAttributesEnumValues) {
			...
			case lastSampleTime:
				...
				break;
			case totalTime:
				String totalTimeStr = NumberUtils.format(totalTime, NumberUtils.FORMATTER_COMMAS);
				addKeyValue(sb, statsAttributesEnumValue1.toString(), totalTimeStr);
				break;
			}
		}
