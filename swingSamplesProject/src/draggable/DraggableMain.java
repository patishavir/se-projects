...
public class DraggableMain {

	public static JFrame frame;
	public static JPanel album;
	private static final String IMAGES_FOLDER = "C:\\oj\\projects\\swingSamplesProject\\src\\draggable\\images\\";
	...
	public static void main(String[] args) {
		...
		album.setLayout(null);// !! IMPORTAN !! you have to set a free layout at
								// least ( FREE, ABSOLUTE, NULL is best)
	...
	public static void addNewPhoto(String fileName) {
		...
		Image img = Toolkit.getDefaultToolkit().createImage(IMAGES_FOLDER + fileName);
		...
		photo.setLocation(cx + getRandom(delta / 2) - photo.getWidth() / 2, cy
				+ getRandom(delta / 2) - photo.getHeight() / 2);
		album.repaint();
	}
