...
public class GradientButton {
	...
	public static void main(String[] args) {
		...
		if (grad instanceof List) {
			...
			// gradient.set(2, new ColorUIResource(221, 232, 243));//origal
			// Color
			// gradient.set(2, new ColorUIResource(255, 255, 255));//origal
			// Color
			// gradient.set(2, new ColorUIResource(184, 207, 229));//origal
			// Color
