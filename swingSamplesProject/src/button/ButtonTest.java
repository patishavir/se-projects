...
public class ButtonTest {
	...
	public void createAndShowGUI() {
		...
		softButton1.setBackground(Color.LIGHT_GRAY);
		frame = new JFrame();
		...
		Timer alphaChanger = new Timer(60, new ActionListener() {
		...
		alphaChanger.start();
		Timer uiChanger = new Timer(1500, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < laf.length - 1; i++) {
					System.out.print(laf.toString() + "\n");
				}
			}
		});
		uiChanger.start();
