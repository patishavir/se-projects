...
/**
 * The undo applet defines the undo / redo concpet in swing. The applet allow
...
public class UndoPanel extends JPanel {
	...
	public UndoPanel() {
		...
		undoPanel.setBorder(BorderFactory.createTitledBorder(LineBorder.createBlackLineBorder(),
				"Undo/ Redo", TitledBorder.LEFT, TitledBorder.TOP));
		...
		actionPanel.setBorder(BorderFactory.createTitledBorder(LineBorder.createBlackLineBorder(),
	...
	private class AddAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent evt) {
			...
			// record the effect
			UndoableEdit edit = new AddEdit(elementModel_, element, NumOfElements);
	...
	private class RemoveAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent evt) {
			...
			// create the edit
			UndoableEdit edit_ = new RemoveEdit(elementModel_, selectedElement, selectIdx);
	...
	/**
	 * An undo/redo adpater. The adpater is notified when an undo edit
	 * occur(e.g. add or remove from the list) The adptor extract the edit from
	...
	/**
	 * The list selection adpater change the remove button state according to
