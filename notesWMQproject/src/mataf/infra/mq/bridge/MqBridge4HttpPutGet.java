...
public class MqBridge4HttpPutGet {
	...
	private static String put() {
		...
		try {
			...
			Map<String, List<String>> responseHeader = httpUrlConnectionPut.getHeaderFields();
	...
	private static String get(final List<String> msgID) {
		String response = null;
		...
		try {
			...
			if (msgID != null) {
				...
				httpUrlConnectionGet.setRequestProperty("x-msg-msgId", msgID.get(0));
