 ...
 * <p>
 * Usage: <code> java -cp examples.jar examples.TestPKCS12KeyStore
...
public class TestPKCS12KeyStore {
	...
	public static void main(String[] argv) {
		try {
			// Check arguments
			if (argv.length != 2) {
				System.out.println("usage: TestPKCS12KeyStore <dirname> " + "<password>");
				System.exit(1);
			}
			...
			while (e.hasMoreElements()) {
				...
				System.out.println(alias + " (" + (p12.isKeyEntry(alias) ? "cert" : "trusted cert")
						+ ")");
