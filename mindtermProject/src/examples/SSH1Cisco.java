/******************************************************************************
 *
 * Copyright (c) 1999-2008 AppGate Network Security AB. All Rights Reserved.
 * 
...
/**
 * Examples on how to connect to an old Cisco device and send a single command.
 * All using the ssh1 classes.
 * <p>
 * Usage: <code> java -cp examples.jar examples.SSH1Cisco
...
public class SSH1Cisco extends SSHInteractorAdapter implements SSHAuthenticator, SSHClientUser {
	 ...
	 */
	SSH1Cisco(String host, String port, String user, String pass) throws IOException {
	...
	public static void main(String argv[]) {
		...
		try {
			SSH1Cisco ssh1 = new SSH1Cisco(argv[0], argv[1], argv[2], argv[3]);
			ssh1.runCmd(argv[4]);
			ssh1.close();
