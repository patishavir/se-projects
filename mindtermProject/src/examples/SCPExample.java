...
/**
 * Copy a file to/from an SSH2 server using the scp protocol. The scp protocol
 * was introduced with ssh1 and is very similar to the rcp protocol. This
 * example used the scp protocol over an ssh2 connection.
 * <p>
 * Usage: <code> java -cp examples.jar examples.SCPExample
...
public class SCPExample {
	...
	public static void main(String[] argv) {
		if (argv.length < 6) {
			System.out
					.println("Usage: SCPExample <server:port> <username> <password> to|from <src_file> <dst_file>");
			System.exit(1);
		}
