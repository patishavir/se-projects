...
/**
 * Login and start a subsystem. Needs to be expanded to actually handle the
 * communication with the subsystem. See place marked XXX in the code.
 * <p>
 * Usage: <code> java -cp examples.jar examples.SubSystem
