...
public class PortalDeploymentParameters {
	...
	private static String matafPortalVersionFolder = null;
	private static String matafPortalBackupFolder = null;
	...
	public static String getMatafPortalBackupFolder() {
		return matafPortalBackupFolder;
	}
	...
	public static String getMatafPortalVersionFolder() {
		return matafPortalVersionFolder;
	}
	...
	public static void setMatafPortalBackupFolder(String matafPortalBackupFolder) {
		PortalDeploymentParameters.matafPortalBackupFolder = matafPortalBackupFolder;
	}
	...
	public static void setMatafPortalVersionFolder(String matafPortalVersionFolder) {
		PortalDeploymentParameters.matafPortalVersionFolder = matafPortalVersionFolder;
	}
