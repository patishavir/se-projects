...
public class GmSmsParameters {
	...
	private static final String ADDRESS_TYPE_SMS = "SMS";
	...
	public final void setTo(final String to) {
		...
		if (toArray.length > 0 && !(RegexpUtils.matches(toArray[0], RegexpUtils.REGEXP_CELL_PHONE_NUMBER))) {
			addressType = ADDRESS_TYPE_AD;
		} else {
			addressType = ADDRESS_TYPE_SMS;
		}
